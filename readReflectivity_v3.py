...
#filenames = ['../omegaMgO_38691/38691_Rfit_v2.txt',  '../omegaMgFeO_38693/38693_Rfit_v2.txt', '../omegaMgFeO_38694/38694_Rfit_v2.txt', '../omegaMgO_39874/39874_Rfit.txt', '../omegaMgFeO_39877/39877_Rfit.txt', '../omegaMgO_39878/39878_Rfit.txt','../omegaMgFeO_39879/39879_Rfit.txt',
...
def open_files(filename, ax,labelname,color):
    ...
    if filename == '../omegaMgFeO_39879/39879_Rfit.txt' or filename == '../omegaMgO_39874/39874_Rfit.txt':
...
#params, covariance = curve_fit(polynomials, xx_combined,yy_combined)
#a,b,c,d  = params
#a_error=np.sqrt(covariance[0,0])
#b_error=np.sqrt(covariance[1,1])
#c_error=np.sqrt(covariance[2,2])
#sys.exit()
...
ax1.set_ylabel('Reflectivity (%)', fontsize=17)
ax2.set_xlabel('Pressure (GPa)', fontsize=17)


ax1.legend(frameon=False,fontsize=8)
fig.savefig('Fig_Rfit.png',dpi=1000)
plt.show()
plt.close()